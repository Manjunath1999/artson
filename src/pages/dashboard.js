...
function DashBoard() {
  ...
  const toggleDrawer = (anchor, open) => (event) => {
    ...
    setState({
      ...Object.fromEntries(
        Object.entries(state).map(([key, value]) => [key, false])
      ),
      [anchor]: open,
    });
  };
                ...
                ? docs.map((children) => {
                    return (
                      <MenuItem
                        ...
                        sx={{
                          backgroundColor:
                            children.key == selectedChildren ? "#4B4B4B" : "",
                        }}
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      {searchFlag && (
        <div style={{ height: "80vh", overflow: "auto", width: "auto" , margin : "0 auto" , marginTop:"7rem"}}>
          <Home
